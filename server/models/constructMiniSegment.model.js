...
const ConstructMiniSegmentSchema = new mongoose.Schema({
  topic: {
    type: String,
    trim: true,
  ...
  constructMiniSegment: {
    type: String,
    trim: true,
    required: "Construct MiniSegment is required",
  },
  markDeleted: {
    type: Boolean,
    default: false,
...
export default mongoose.model("ConstructMiniSegment", ConstructMiniSegmentSchema);
