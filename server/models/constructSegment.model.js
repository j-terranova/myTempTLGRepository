...
const ConstructSegmentSchema = new mongoose.Schema({
  topic: {
    type: String,
    trim: true,
  ...
  constructSegment: {
    type: String,
    trim: true,
    required: "Construct Segment is required",
  },
  markDeleted: {
    type: Boolean,
    default: false,
...
export default mongoose.model("ConstructSegment", ConstructSegmentSchema);
