...
const ConstructQuestionSchema = new mongoose.Schema({
  topic: {
    type: String,
    trim: true,
  ...
  constructQuestion:{
    ...
    questionType: {   //MultipleChoice, FillInBlank, TrueFalse, Other
      type: String,
      default: "",
    },
    correctResponses:{
...
export default mongoose.model("ConstructQuestion", ConstructQuestionSchema);
