...
const ConstructAssociationSchema = new mongoose.Schema({
  topic: {
    type: String,
    trim: true,
  ...
  constructAssociation: {
    ...
    associationType: {   //MultipleChoice, FillInBlank, TrueFalse, Other
      type: String,
      default: "",
    },
    associatedWords:{
...
export default mongoose.model("ConstructAssociation", ConstructAssociationSchema);
