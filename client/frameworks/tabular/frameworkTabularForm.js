...
export default function FrameworkTabularForm(props) {
  const { formValues,
          setFormValues,
          cloneCurrentFrameworkTabular,
          validate,
          errors,
...
console.log("FrameworkTabularForm - displayFrameworkOptions = ",displayFrameworkOptions );
console.log("FrameworkTabularForm - displayFrameworkOptions.frameworkLayoutOptions = ",displayFrameworkOptions.frameworkLayoutOptions );

console.log("FrameworkTabularForm - Start " );
console.log("FrameworkTabularForm - formValues = ",formValues );
console.log("FrameworkTabularForm - errors = ",errors );
...
const handleRequestClone = () => {
    if (validate()) {
      setConfirmDialog({
        isOpen: true,
        title: " Would you like to create a copy of the current tabular?",
        subTitle: "If confirmed, this option will create a new and separate copy of the current tabular.",
        onConfirm: () => {
          cloneCurrentFrameworkTabular();
        },
      });
           ...
           <Grid container alignItems="center">
                ...
                <Grid item xs={12}>
                    <div>
                        ...
                        Access to be Applied to this tabular
                ...
                Tags applied to tabular-Criteria to define audience
