...
export default function FrameworkTicTacToeForm(props) {
  const { formValues,
          setFormValues,
          cloneCurrentFrameworkTicTacToe,
          validate,
          errors,
...
console.log("FrameworkTicTacToeForm - displayFrameworkOptions = ",displayFrameworkOptions );
console.log("FrameworkTicTacToeForm - displayFrameworkOptions.frameworkLayoutOptions = ",displayFrameworkOptions.frameworkLayoutOptions );

console.log("FrameworkTicTacToeForm - Start " );
console.log("FrameworkTicTacToeForm - formValues = ",formValues );
console.log("FrameworkTicTacToeForm - errors = ",errors );
...
const handleRequestClone = () => {
    if (validate()) {
      setConfirmDialog({
        isOpen: true,
        title: " Would you like to create a copy of the current ticTacToe?",
        subTitle: "If confirmed, this option will create a new and separate copy of the current ticTacToe.",
        onConfirm: () => {
          cloneCurrentFrameworkTicTacToe();
        },
      });
           ...
           <Grid container alignItems="center">
                ...
                <Grid item xs={12}>
                    <div>
                        ...
                        Access to be Applied to this ticTacToe
                ...
                Tags applied to ticTacToe-Criteria to define audience
