...
import { create, update } from "./api-frameworkTicTacToe.js";
import FrameworkTicTacToeForm from "./frameworkTicTacToeForm";
...
export default function FrameworkTicTacToeInputPopup(props) {
  const { formValues,
          setFormValues,
          prepareFormValues,
          setOpenPopup,
  ...
  const cloneCurrentFrameworkTicTacToe = () => {
    console.log("FrameworkTicTacToeForm - cloneCurrentFrameworkTicTacToe = ");
    console.log(
      "FrameworkTicTacToeForm - cloneCurrentFrameworkTicTacToe - just before call to clone ticTacToe formValues = ",
      formValues
    );
    ...
    create(
      ...
      if (!data) {
        console.log(
          "FrameworkTicTacToeForm - cloneCurrentFrameworkTicTacToe - No Data so dispatch, Check Criteria"
        );
        setNotify({
          isOpen: true,
          message: "FrameworkTicTacToeForm - cloneCurrentFrameworkTicTacToe - TicTacToe not created! Please try again.. Notify Administrator if problem persists.",
          type: "error",
        });
      } else {
        if (data.error) {
          console.log(
            "FrameworkTicTacToeForm - cloneCurrentFrameworkTicTacToe - error returned = " + data.error
          );
          setNotify({
            isOpen: true,
            message: "FrameworkTicTacToeForm - cloneCurrentFrameworkTicTacToe - TicTacToe not created! Please try again.. Notify Administrator if problem persists.",
          ...
          addLineItems(data)
          setSelected([]);
          console.log("FrameworkTicTacToeForm - cloneCurrentFrameworkTicTacToe - after create - formValues = ", formValues );
          setNotify({
            isOpen: true,
            message: "TicTacToe Cloned",
            type: "success",
          });
        }
      }
  ...
  const createNewFrameworkTicTacToe = () => {
    console.log("FrameworkTicTacToeForm - createNewFrameworkTicTacToe = ");
    const newDate = Date.now();
    console.log(
      "FrameworkTicTacToeForm - just before call to create ticTacToe formValues = ",
      formValues
    );
    let newFramework =  {
    ...
    create(
      ...
      if (!data) {
        console.log(
          "FrameworkTicTacToeForm - No Data so dispatch, Check Criteria"
        );
        setNotify({
          isOpen: true,
          message: "TicTacToe not created! Please try again.. Notify Administrator if problem persists.",
          type: "error",
        });
      } else {
        if (data.error) {
          console.log(
            "FrameworkTicTacToeForm - error returned = " + data.error
          );
          setNotify({
            isOpen: true,
            message: "TicTacToe not created! Please try again.. Notify Administrator if problem persists.",
          ...
          console.log("FrameworkTicTacToeForm - after create - data = ", data );
          console.log("FrameworkTicTacToeForm - after create - data._id = ", data._id );
          ...
          console.log("FrameworkTicTacToeForm - after create - formValues = ", formValues );
          setNotify({
            isOpen: true,
            message: "TicTacToe Created",
            type: "success",
          });
        }
      }
  ...
  const updateExistingFrameworkTicTacToe = (matchingIndex) => {
  ...
  update(
      ...
      if (!data) {
        ...
        setNotify({
          isOpen: true,
          message: "TicTacToe not update! Please try again.. Notify Administrator if problem persists.",
          type: "error",
        });
      } else {
        if (data.error) {
          ...
          console.log("FrameworkTicTacToeForm - after create - preparingFormValues with data = ", data );
          console.log("FrameworkTicTacToeForm - after create - preparingFormValues with data = ", data._id );
  ...
  const SaveEntries = () => {
    ...
    console.log(
      "FrameworkTicTacToeForm - SaveEntries clicked before create/update formValues = ",
      formValues
    );
    if (
      ...
      setFormValues({
        ...
        isError: true,
        errorMessage:
          "Error alert!!! You must have an entry for topic, description and ticTacToe before saving!",
      });
      return;
    }
    if (
    ...
    console.log("FrameworkTicTacToeForm - search for id =  ", formValues._id); 
    const matchingIndex = findMatchingIndex(formValues._id);
    
    if (matchingIndex >= 0) {
      console.log(
        "FrameworkTicTacToeForm - index match found! matchingIndex =  " + matchingIndex
      );
      updateExistingFrameworkTicTacToe(matchingIndex);
    } else {
      console.log(
        "FrameworkTicTacToeForm - index match NOT found! matchingIndex =  " + matchingIndex
      );
      createNewFrameworkTicTacToe();
    }
    console.log("FrameworkTicTacToeForm End of Save Entries !!");
  };
    ...
    {/*<Paper className={classes.paper}>*/}
      <CssBaseline />
          ...
          <Grid item xs={12} >
            ...
            <Grid item xs={12} > 
            {/*<Paper className={classes.paper}>   */}       
                <FrameworkTicTacToeForm 
                      formValues = {formValues}
                      setFormValues = {setFormValues}
                      cloneCurrentFrameworkTicTacToe = {cloneCurrentFrameworkTicTacToe}
                      validate={validate}
                      errors={errors}
