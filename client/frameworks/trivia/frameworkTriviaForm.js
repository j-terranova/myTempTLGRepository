...
export default function FrameworkTriviaForm(props) {
  const { formValues,
          setFormValues,
          cloneCurrentFrameworkTrivia,
          validate,
          errors,
...
console.log("FrameworkTriviaForm - displayFrameworkOptions = ",displayFrameworkOptions );
console.log("FrameworkTriviaForm - displayFrameworkOptions.frameworkLayoutOptions = ",displayFrameworkOptions.frameworkLayoutOptions );

console.log("FrameworkTriviaForm - Start " );
console.log("FrameworkTriviaForm - formValues = ",formValues );
console.log("FrameworkTriviaForm - errors = ",errors );
...
const handleRequestClone = () => {
    if (validate()) {
      setConfirmDialog({
        isOpen: true,
        title: " Would you like to create a copy of the current trivia?",
        subTitle: "If confirmed, this option will create a new and separate copy of the current trivia.",
        onConfirm: () => {
          cloneCurrentFrameworkTrivia();
        },
      });
           ...
           <Grid container alignItems="center">
                ...
                <Grid item xs={12}>
                    <div>
                        ...
                        Access to be Applied to this trivia
                ...
                Tags applied to trivia-Criteria to define audience
