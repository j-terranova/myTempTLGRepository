...
export default function ConstructRootWordForm(props) {
  const { formValues,
          setFormValues,
          validate,
          errors,
...
console.log("ConstructRootWordForm - Start " );
console.log("ConstructRootWordForm - formValues = ",formValues );
...
<>
    ...
    {formValues.isError && (
      ...
      <Grid item xs={12} >
          <div>
              Access to be Applied to this rootWord
          </div>
          </Grid>
          <Grid container >
          <Grid item xs={6} >
    ...
    Tags applied to rootWord-Criteria to define audience
