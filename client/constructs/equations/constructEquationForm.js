...
export default function ConstructEquationForm(props) {
  const { formValues,
          setFormValues,
          validate,
          errors,
...
console.log("ConstructEquationForm - Start " );
console.log("ConstructEquationForm - formValues = ",formValues );
...
<>
    ...
    {formValues.isError && (
      ...
      <Grid item xs={12} >
          <div>
              Access to be Applied to this equation
          </div>
          </Grid>
          <Grid container >
          <Grid item xs={6} >
    ...
    Tags applied to equation-Criteria to define audience
