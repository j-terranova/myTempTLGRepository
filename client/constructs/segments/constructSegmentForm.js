...
export default function ConstructSegmentForm(props) {
  const { formValues,
          setFormValues,
          validate,
          errors,
...
console.log("ConstructSegmentForm - Start " );
console.log("ConstructSegmentForm - formValues = ",formValues );
...
<>
    <Form onSubmit={handleSubmit}>
      ...
      <Grid item xs={12} >
          <div>
              Access to be Applied to this segment
          </div>
          </Grid>
          <Grid container >
          <Grid item xs={6} >
    ...
    Tags applied to segment-Criteria to define audience
