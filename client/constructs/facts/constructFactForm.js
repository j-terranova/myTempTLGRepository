...
export default function ConstructFactForm(props) {
  const { formValues,
    setFormValues,
    validate,
    errors,
...
console.log("ConstructFactForm - Start " );
console.log("ConstructFactForm - formValues = ",formValues );
...
<>
    ...
    />
      ...
      <Grid item xs={12}>
          <div>
              Access to be Applied to this fact
          </div>
          </Grid>
          <Grid container >
          <Grid item xs={6} >
    ...
    Tags applied to fact-Criteria to define audience
