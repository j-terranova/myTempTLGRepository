...
import { loadGutenbergFactData } from "./api-constructFact.js";
...
export default function ConstructFactImport(props) {
...
console.log("ConstructFactImport" );
...
console.log("ConstructFactImport - after setImportValues = ",importValues );
  ...
  const loadFile = () => {
    loadGutenbergFactData(
      ...
      if (!data) {
        ...
        if (data.error) {
          console.log(
            "ConstructFactImport - load error returned = " + data.error
          );
        } else {
          console.log("ConstructFactImport - load data =  " + data);

          }
          setNotify({
            isOpen: true,
            message: "File Load of Facts Completed",
            type: "success",
          });
        }
      }
        ...
        <Form onSubmit={handleSubmit}>
            ...
            <Grid item xs={12}>
              <Typography variant="h6" className={classes.title}>
                Each new fact record will include entries as you have assigned them on this form.
                You can enter or leave blank entries for topic, tittle and/or description.
                Imput file must be comma delimited.  
                Input file must contain the fact.  The file may also contain; topic, title and description.
                ...
                Fact must always be included.  It can be the only file entry if other data is on the form.
              </Typography>
            </Grid>

            <Grid item xs={6}>
                   <Controls.Button
                    text="Import Facts from Fact File"
                    variant="contained"
                    color = "primary"
            ...
            <Grid item xs={6}>
                ...
                <Grid item xs={6}>
                    <div>
                        ...
                        Access to be applied to imported facts
                ...
                Criteria/Tags to be applied to imported facts
