...
export default function ConstructMiniSegmentForm(props) {
        const { formValues,
                setFormValues,
                validate,
                errors,
...
console.log("ConstructMiniSegmentForm - Start " );
console.log("ConstructMiniSegmentForm - formValues = ",formValues );
...
const handleSave = (e) => {
e.preventDefault()
console.log("ConstructMiniSegmentForm - handleSave - start");
...
const handleAddNew = () => {
console.log("ConstructMiniSegmentForm - handleAddNew - Start")
console.log("ConstructMiniSegmentForm - handleAddNew - formValues.modified = ", formValues.modified)
if (formValues.modified)
{
  setConfirmDialog({
    isOpen: true,
    ...
    onConfirm: () => {
      console.log("ConstructMiniSegmentForm - right before validate")
      if (validate()) {
        console.log("ConstructMiniSegmentForm - After validate right before save")
        addNewConstruct(); 
      }
    }
  }); 
...
{
  console.log("ConstructMiniSegmentForm - in else when modified not true")
  addNewConstruct();
}
}
...
<>
    <Form onSubmit={handleSubmit}>
        ...
        <Grid item xs={12}>
          <Controls.Input
              name="constructMiniSegment"
              label="MiniSegment"
              multiline
              rowsMin={8}
              value={formValues.constructMiniSegment}
              onChange={handleInputChange}
              error={errors.constructMiniSegment}
          />
      </Grid>
      <Divider/>
      <Grid container >
    ...
    />
      ...
      <Grid item xs={12}>
          <div>
              Access to be Applied to this miniSegment
          </div>
          </Grid>
          <Grid container >
          <Grid item xs={6} >
    ...
    Tags applied to miniSegment-Criteria to define audience
