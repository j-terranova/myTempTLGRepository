...
import GamerPreferencesForm from "./gamerPreferencesForm";
...
export default function GamerPreferencesContainer() {
  ...
  const [formValues, setFormValues] = useState({
    ...
    preferredGamerLevel:   gamerPreferences.preferredGamerLevel?gamerPreferences.preferredGamerLevel: 4,
